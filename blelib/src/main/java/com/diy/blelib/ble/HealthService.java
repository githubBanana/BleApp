...
public class HealthService extends BleProfileService implements HealthManagerCallbacks{
	...
	private HealthManager mManager;
	...
	@Override
	protected BleManager<HealthManagerCallbacks> initializeManager() {
		return mManager = HealthManager.getHTSManager();
	}
...
//		createNotifcation(R.string.hts_notification_connected_message, 0);
	...
	public void onOXYValueReceived(int value) {
		// TODO Auto-generated method stub
		Log.i(TAG, "yyyyyyyyyyyyyyyy2222");
		final Intent broadcast = new Intent(BROADCAST_OXY_MEASUREMENT);
		broadcast.putExtra(EXTRA_OXYGEN, value);
		LocalBroadcastManager.getInstance(this).sendBroadcast(broadcast);
	}
